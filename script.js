...
const thaiChessContent = `
  <h2>🐘 หมากรุกไทย </h2>
  <p>ฝึกการคิด วางแผน และไหวพริบไปกับหมากรุกไทย เกมกระดานคู่คนไทย เล่นสนุก เข้าใจง่าย เหมาะทั้งมือใหม่และคนที่อยากพัฒนาฝีมือ</p>
  <p><strong>การรับสมัครเข้าชมรม</strong></p>
  <p>มีสมาชิก 30 คน รับสมัคร 30 คน สามารถกดสมัครผ่านเว็ปไซต์ กช. ได้เลย</p>
`;

const normalChessContent = `
  <h2>♛ หมากรุกสากล </h2>
  <p>เรียนรู้การคิดเชิงกลยุทธ์กับหมากรุกสากล สนุกกับการวางแผนอย่างเป็นระบบ พร้อมพัฒนาทักษะการเล่นไปด้วยกัน</p>
  <p><strong>การรับสมัครเข้าชมรม</strong></p>
  <p>มีสมาชิก 30 คน รับสมัคร 15 คน คัดเลือกผ่านการแข่งขันแบบ Swiss System</p>
  <p>รายละเอียดการแข่งขันจะแจ้งให้ทราบภายหลัง มาสมัครกันเยอะๆนะครับ</p>
`;
